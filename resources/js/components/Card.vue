<template>
    <div
        class="group bg-white shadow-card rounded-sm p-2 cursor-pointer text-sm hover:bg-gray-100 mb-2 card flex justify-between"
    >
        <div>{{ card.title }}</div>
        <div
        ...
        >
            ...
            <div @click="cardDelete" class="text-gray-400 hover:text-red-700">
                D
            </div>
        </div>
    </div>
